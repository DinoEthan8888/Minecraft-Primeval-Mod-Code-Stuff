...
public class ModConfiguration 
{
	...
	public static int ENTITY_AVISAURUS_ID = 202;
	
	public static int ENTITY_OBAMADON_ID = 203;
	
	public static int DIMENSION_LATE_CRETACEOUS_NORTH_AMERICA_1_ID = 1;
	
	public static boolean spawnCustomBiomesInOverworld = true;
	
	//public static boolean spawnAmberOre = true;
	...
	public static void init(File file)
	{
		...
		ENTITY_OBAMADON_ID = config.getInt("ENTITY_OBAMADON_ID", category, 201, 201, 999, "Entity IDs below 201 are used by Minecraft");
