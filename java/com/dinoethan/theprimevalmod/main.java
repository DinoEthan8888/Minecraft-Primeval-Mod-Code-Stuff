...
import com.dinoethan.theprimevalmod.llibrary.LibDependencies;
...
@Mod(modid = reference.MOD_ID, name = reference.NAME, version = reference.VERSION, dependencies = LibDependencies.DEPENDENCIES)
public class main {
	...
	public static final Logger LOGGER = LogManager.getLogger("primeval");
